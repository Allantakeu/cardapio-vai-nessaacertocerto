...
(function () {
  ...
  window.VN = {
    ...
    sql: [
      ...
      '-- preenchido aqui porque retirada na loja não pede telefone.',
      ...
      "      or regexp_replace(detail->>'indicadoPor', '\\D', '', 'g') <> regexp_replace(coalesce(detail->>'telefone', ''), '\\D', '', 'g')",
      '    )',
      '  )',
      ');',
      ...
      'set search_path = public',
      'as $$',
      '  select count(distinct regexp_replace(coalesce(ve.detail->>\'telefone\', \'\'), \'\\D\', \'\', \'g\'))::int',
      '  from vn_events ve',
      '  left join lateral (',
      '    select data->\'orderStatus\' as os from vn_catalog where id = \'main\'',
      '  ) c on true',
      '  where ve.type = \'order\'',
      '    and regexp_replace(coalesce(ve.detail->>\'indicadoPor\', \'\'), \'\\D\', \'\', \'g\') = regexp_replace(coalesce(p_phone, \'\'), \'\\D\', \'\', \'g\')',
      '    and coalesce(ve.detail->>\'indicadoPor\', \'\') <> \'\'',
      '    and coalesce(p_phone, \'\') <> \'\'',
      '    and coalesce(c.os->>coalesce(ve.id::text, \'\'), \'\') <> \'cancelado\'',
      '    and regexp_replace(coalesce(ve.detail->>\'telefone\', \'\'), \'\\D\', \'\', \'g\') <> regexp_replace(coalesce(p_phone, \'\'), \'\\D\', \'\', \'g\');',
      '$$;',
