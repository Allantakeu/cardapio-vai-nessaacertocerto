...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none só entra em modo reframe (arrastar/pan pra reenquadrar).
    // Aplicado sempre, isso capturava todo toque na imagem — inclusive na
    // vitrine pública, que nunca entra em reframe — e travava a rolagem da
    // página inteira (vertical) sempre que o dedo tocasse numa foto.
